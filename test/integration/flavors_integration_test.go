...
func TestListFlavors(t *testing.T) {
	...
	// Verify a GPU flavor.
	assertFlavor(t, flavorsBySlug, "gpu2-128-16-1-200", 16, 128, &cloudscale.GPU{
		Count: 1,
	})
}

func assertFlavor(t *testing.T, flavors map[string]cloudscale.Flavor, slug string, expectedVCPUs int, expectedMemoryGB int, expectedGPU *cloudscale.GPU) {
	t.Helper()
